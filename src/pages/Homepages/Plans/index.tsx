...
const Plans: React.FC<Props> = () => {
  ...
  return (
    <section className='bg-[#E3343F] py-24 px-[175px]'>
      <div className='mb-8'>
        <h2 className='text-white text-4xl font-bold wow animate__fadeInDown'>
          {language === 'en' ? 'Built to fit your business' : 'Thiết kế phù hợp với doanh nghiệp của bạn'}
        </h2>
        <p className='text-white mt-6 wow animate__fadeInDown'>
          {language === 'en' ? 
      ...
      <div className='flex justify-between gap-8'>
        <div className='text-white w-1/4 wow animate__fadeInUp'>
        ...
        <div className='text-white w-1/4 wow animate__fadeInUp' data-wow-delay="0.2s">
        ...
        <div className='text-white w-1/4 wow animate__fadeInUp' data-wow-delay="0.4s">
        ...
        <div className='text-white w-1/4 wow animate__fadeInUp' data-wow-delay="0.6s">
